...
def main():
	print(' ')
	print('You are now using the Shawn Kairigo app for managing passwords.')
	while True:
		print(' ')
		print("-"*60)
		...
		if short_code == 'ex':
			...
			first_name = input('Enter your  name below eg. Shawn - ').strip()
			last_name = input('Enter your nickname for example Rigz - ').strip()
					...
					if short_code == 'ex':
						...
						while True:
							...
							if psw_choice == 'ep':
								...
								print('Sadly, you have entered the wrong option. Kindly try again.')
